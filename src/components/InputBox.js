  ...
  return (
    <div className={'bg-white p-3 rounded-lg text-sm flex'}>
        ...
        <div className="w-1/2 flex flex-wrap justify-end text-right">
            ...
            <select className='rounded-lg px-1 py-1 bg-gray-100 cursor-pointer outline-none' disabled={currencyDisable} value={selectCurrency} onChange={(e)=>onCurrencyChane && onCurrencyChane(Number(e.target.value))}>
